...
export const dictionaries = {
  es: {
    ...
    home: {
      ...
      dealsEyebrow: "🔥 Chollos en tiempo real",
      dealsTitle: "Los mejores chollos de hoy",
      dealsSubtitle: "Detectados automáticamente en Amazon, AliExpress y El Corte Inglés.",
      dealsCta: "Ver todos los chollos →",
      channelCta: {
    ...
    deal: {
      ...
      aboutH: "Sobre este producto",
      savings: "ahorras",
      whyH: "¿Por qué es una buena oferta?",
      whyLead: "Precio detectado muy por debajo del habitual. Si todavía está disponible, puede ser el momento de comprarlo.",
      trackH: "Sigue el precio gratis",
      trackLead: "Si ya no está disponible o quieres esperar a que baje más, el bot vigila por ti.",
      trackSteps: [
        { icon: "✈️", h: "Abre el bot", p: "Busca @Ahorrazone_bot en Telegram." },
        { icon: "🔗", h: "Pega el enlace", p: "Copia la URL del producto y pégala en el chat." },
        { icon: "🔔", h: "Recibe la alerta", p: "Te avisamos al instante cuando baje el precio." },
      ],
      communityH: "Recibe la próxima oferta antes que nadie",
      communityP: "En el canal de Ahorrazone Hunters publicamos cada día los mejores chollos de Amazon, AliExpress y El Corte Inglés — con datos reales de precios, no publicidad.",
      communityCta: "Unirse al canal gratis →",
    },
    privacy: {
  ...
  en: {
    ...
    home: {
      ...
      dealsEyebrow: "🔥 Live deals",
      dealsTitle: "Best deals spotted today",
      dealsSubtitle: "Automatically detected on Amazon, AliExpress and El Corte Inglés.",
    ...
    deal: {
      ...
      aboutH: "About this product",
      savings: "you save",
      whyH: "Why is this a good deal?",
      whyLead: "Price spotted well below the usual retail price. If it's still available, this could be the right moment.",
      trackH: "Track the price for free",
      trackLead: "If it's sold out or you want to wait for an even lower price, the bot keeps watch for you.",
      trackSteps: [
        { icon: "✈️", h: "Open the bot", p: "Search for @Ahorrazone_bot on Telegram." },
        { icon: "🔗", h: "Paste the link", p: "Copy the product URL and paste it in the chat." },
        { icon: "🔔", h: "Get the alert", p: "We ping you instantly when the price drops." },
      ],
      communityH: "Get the next deal before anyone else",
      communityP: "In the Ahorrazone Hunters channel we post the best Amazon, AliExpress and El Corte Inglés deals every day — backed by real price data, not ads.",
      communityCta: "Join the channel for free →",
    },
    privacy: {
