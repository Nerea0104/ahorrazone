...
export const dictionaries = {
  es: {
    ...
    home: {
      ...
      channelCta: {
        eyebrow: "Canal de Telegram gratuito",
        h: "Los mejores chollos, cada día",
        p: "Únete a nuestra comunidad y recibe los mejores descuentos de Amazon, AliExpress y El Corte Inglés sin configurar nada.",
  ...
  en: {
    ...
    home: {
      ...
      channelCta: {
        eyebrow: "Free Telegram channel",
        h: "The best deals, every day",
        p: "Join our community and get the best discounts from Amazon, AliExpress and El Corte Inglés without any setup.",
